...
System.out.println(organizationDetail.toJSONString());
%>
</script>
<style type="text/css">
</style>
			...
			<div class="body-div">
				...
				<div class="main-div">
					...
					<div class="rgt-main-div">
							<input
											class="o-name c-name" type="text" value="<%=organizationDetail.get("organizationname") %>" 
											disabled="">
						<div>
								...
								<tbody>
									<tr>
										...
										<td width="51%"><input type="text" id="custName" style="background: white;"
											...
											placeholder="Your Name" value="Vivah The Wedding" disabled="disabled">
											...
											</div> <br> <input type="text" id="address1" class="adr"
											tabindex-old="2" placeholder="Your Company" value="14, Town Hall Road"
											onfocus="javascript:CreateInvoiceUtil.showHelpText(0)">
											<br> <input type="text" id="address2" class="adr" 
											tabindex-old="3" placeholder="Companyâs Address" value="Opp. Nagar Nigam"
											onfocus="javascript:CreateInvoiceUtil.showHelpText(0)">
											<br> <input type="text" class="adr" id="address3" 
											tabindex-old="4" placeholder="City, State Zip" value="Udaipur-313001"
											onfocus="javascript:CreateInvoiceUtil.showHelpText(0)">
											<br> <input type="text" class="adr" tabindex-old="4"
											id="address4" placeholder="Country" value="+91-8104854301"
											onfocus="javascript:CreateInvoiceUtil.showHelpText(0)">
											<br></td>
										...
										<td width="50%" class="vtop tc" colspan="3">
											...
											class="c-name" type="text" value="<%=organizationDetail.get("telephonenumber") %>" style="width:40%;text-align:left" tabindex-old="5"
											onfocus="javascript:CreateInvoiceUtil.showHelpText(6)">
											<input id="invoiceTextBox"
											class="c-name" type="text" value="INVOICE" style="font-weight:bold;width:20%;" tabindex-old="5"
											onfocus="javascript:CreateInvoiceUtil.showHelpText(6)">
											<input id="invoiceTextBox"
											class="c-name" type="text" value="<%=organizationDetail.get("tinnumber") %>" style="width:35%;text-align:right;" tabindex-old="5"
											onfocus="javascript:CreateInvoiceUtil.showHelpText(6)">
							<ul style="width: 100%; margin-top: 2px;margin-bottom:-20px;">
								<li class="adr-rgt">
									<table width="100%" cellpadding="0" cellspacing="0"
										...
										<tbody>
											...
											<tr>
											<td class="lft-txt"><input type="text"
													value="Table No." id="invoiceTypeLabel" class="bld"
													tabindex-old="14"
													onfocus="javascript:CreateInvoiceUtil.showHelpText(2)">
												</td>
												<td>
								...
								<li class="adr-lft"><input type="text" value="Bill To:"
									...
									<br> <input type="text" id="billingAddress1" class="adr bld bill-to customerName"
    	...
    	<tr class="hd headerclass" id="header_row">
            ...
            <td  class=" rat-col Itemcode-col" style="width:50px;display:<%= displayProp%>;">
            	<input style="border:none;text-align: center;" type="text" value="P. Rate" id="itemPurchasePrice" class="bld" tabindex-old="19" onfocus="javascript:CreateInvoiceUtil.showHelpText(3)" disabled="disabled">
                 ...
                 <td  class="" style="display:<%= discountDisplayProp%>;">
            	<input style="width:100%;border:none;text-align: center;" type="text" value="disc %" id="itemRateLabel" class="bld" tabindex-old="19" onfocus="javascript:CreateInvoiceUtil.showHelpText(3)" disabled="disabled">
          ...
          <td class="Itemserial-col" style="border-right:solid 1px black;">
           ...
           <td class="Itemcode-col" style="border-right:solid 1px black;">
            ...
            <td class="rat-col Itemcode-col" style="border-right:solid 1px black;display:<%= displayProp%>;">
             ...
             <td class="rat-r" style="border-right:solid 1px black;display:<%= discountDisplayProp%>;">
