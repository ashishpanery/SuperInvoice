			...
			<div class="body-div">
				...
				<div class="main-div">
					...
					<div class="rgt-main-div">
							<input class="o-name c-name" type="text" value="Shree Ganesh Enterprises" disabled="">
<input class="o-name c-name" type="text" value="(Pizza World)" disabled="">
						<div>
								...
								<tbody>
									<tr>
										...
										<td width="50%" class="vtop tc" colspan="3">
											...
											<input id="invoiceTextBox"
											class="c-name" type="text" value="TIN Number: 08684006909" style="width:100%;text-align:center;" tabindex-old="5"
											onfocus="javascript:CreateInvoiceUtil.showHelpText(6)">
										...
										<tbody>
											<tr style="display:;">
												...
												<td><input type="text" id="invNumber" tabindex-old="13"
													value="<%=InvoiceMaster.getUniqueInvoiceNumber()%>" disabled="disabled"
													onfocus="javascript:CreateInvoiceUtil.showHelpText(2)">
												</td>
											</tr>
											<tr>
											...
											<td class="lft-txt"><input type="text"
												...
												<td>
												<input type="text" id="invoiceType" style="float:left;">
         ...
         <div style="width:60%;"></div>          
               ...
               <tr class="tot" style="background:#e3e3e3;">
						...
						<div class="power" style="display: ;">
								...
								<ul><br>
									<input id="invoiceTextBox"
											class="c-name" type="text" value="Thanks & Please visit Again" style="width:100%;text-align:center;" tabindex-old="5"
											onfocus="javascript:CreateInvoiceUtil.showHelpText(6)">
							<ul style="width: 100%; margin-top: 2px;margin-bottom:-20px;">
