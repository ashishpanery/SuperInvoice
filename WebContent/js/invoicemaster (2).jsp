			...
			<div class="container-fluid">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right nav-web-perf">
						...
						%>
							<li><a href="InvoiceHistory.jsp"><span
							class="glyphicon glyphicon-flash"></span>Invoice History</a></li>
			...
			<div class="body-div">
				...
				<div class="main-div">
					...
					<div class="rgt-main-div">
							<input
											class="c-name" type="text" value="J.S." 
											disabled="disabled">
						<div>
								...
								<tbody>
									<tr>
										...
										<td width="51%"><input type="text" id="custName" style="background: white;"
											...
											tabindex-old="3" placeholder="Company’s Address" value="Opp. Nagar Nigam"
											onfocus="javascript:CreateInvoiceUtil.showHelpText(0)">
    ...
    <thead>
       ...
       <tr class="row-item  " onclick="javascript:CreateInvoiceUtil.showHelpText(3)" id="lineItem.1" onmouseover="javascript:CreateInvoiceUtil.showCloseIcon(this,true)" onmouseout="javascript:CreateInvoiceUtil.showCloseIcon(this,false)">
        ...
        <!--      <td class="desc-r" style="border-right:solid 1px black;border-left:solid 1px black;">
            ...
            <td class="rat-col Itemcode-col" style="border-right:solid 1px black;display: <%= displayProp%>;">
            	<input type="text" value="0.00" tabindex-old="24" id="itemPurchase.1" disabled="disabled" onblur="javascript:CreateInvoiceUtil.calculateItemTotal(this)">
            </td>
            <td class="rat-r" style="border-right:solid 1px black;display:none;">
